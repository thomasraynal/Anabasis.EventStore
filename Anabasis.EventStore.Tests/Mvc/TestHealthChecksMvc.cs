...
namespace Anabasis.EventStore.Tests
{
    ...
    public class TestStatefulActorOneHealthChecksMvc : SubscribeToAllStreamsEventStoreStatefulActor<SomeDataAggregate>
    {
    ...
    public class TestStartupHealthChecks
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddWorld(TestHealthChecksMvcTestBed.TestBed.ClusterVNode, TestHealthChecksMvcTestBed.TestBed.ConnectionSettings)
                    ...
                    .AddEventStoreStatefulActor<TestStatefulActorOneMvc, SomeDataAggregate, AllStreamsCatchupCacheConfiguration>(eventTypeProvider)
                    .WithBus<IEventStoreBus>((actor, bus) => actor.SubscribeToAllStreams(Position.End))
                    .CreateActor()

                    .AddEventStoreStatefulActor<TestBusRegistrationStatefullActor, SomeDataAggregate, AllStreamsCatchupCacheConfiguration>(eventTypeProvider)
                    .WithBus<IEventStoreBus>((actor, bus) => actor.SubscribeToAllStreams(Position.End))
                    .CreateActor()
    ...
    public class TestHealthChecksMvc
    {
        ...
        public async Task ShouldAddBusAndEvaluateHealthChecks()
        {
            ...
            testStatefulActorOneMvc.Dispose();
