...
namespace Anabasis.EventStore.Tests
{
    ...
    public class TestMultipleStreamsCacheSnapshots
    {
        ...
        public async Task ShouldCreateAndRunAnEventStoreRepositoryAndEmitEventsAndCreateSnapshot()
        {
            ...
            await _eventStoreRepositoryAndConnectionMonitor.eventStoreRepository.Emit(new SomeDataAggregateEvent(_streamIdOne, Guid.NewGuid()));
            await _eventStoreRepositoryAndConnectionMonitor.eventStoreRepository.Emit(new SomeDataAggregateEvent(_streamIdTwo, Guid.NewGuid()));
            await _eventStoreRepositoryAndConnectionMonitor.eventStoreRepository.Emit(new SomeDataAggregateEvent(_streamIdThree, Guid.NewGuid()));
        ...
        {
            await _multipleStreamsCatchupCacheOne.catchupEventStoreCache.DisconnectFromEventStream();
