...
namespace Anabasis.EventStore.Tests
{
    ...
    public class TestCacheSubscription
    {
        ...
        private (ConnectionStatusMonitor connectionStatusMonitor, AllStreamsCatchupCache<Guid, SomeDataAggregate<Guid>> catchupEventStoreCache, ObservableCollectionExtended<SomeDataAggregate<Guid>> someDataAggregates) _cacheTwo;
