...
namespace Anabasis.EventStore.Connection
{
    ...
    public class ConnectionStatusMonitor : IConnectionStatusMonitor
    {
        ...
        public ConnectionStatusMonitor(Func<IEventStoreConnection> getEventStoreConnection, ILoggerFactory loggerFactory = null) 
            : this(getEventStoreConnection(), loggerFactory)
        {
        }
