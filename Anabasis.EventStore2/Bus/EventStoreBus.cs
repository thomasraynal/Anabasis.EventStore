...
#nullable enable
        ...
        public void SubscribeToOneStream(SubscribeToOneStreamConfiguration subscribeToOneStreamConfiguration)
        {
        ...
        public void SubscribeToManyStreams(SubscribeToOneOrManyStreamsConfiguration subscribeToOneOrManyStreamsConfiguration)
        {

        }

        public void SubscribeToAllStreams(SubscribeToAllStreamsConfiguration subscribeToAllStreamsConfiguration)
        {

        }

        public void SubscribeToPersistentStream(PersistentSubscriptionStreamConfiguration persistentSubscriptionStreamConfiguration)
        {

        }

        public SubscribeToAllEventStoreStream SubscribeFromEndToAllStreams(
            ...
            Action<SubscribeFromEndEventStoreStreamConfiguration>? getSubscribeFromEndEventStoreStreamConfiguration = null)
        {
            ...
            var subscribeFromEndEventStoreStream = new SubscribeToAllStreamsStoreStream(
