...
//                var tableResult = await tableClient.GetEntityAsync<ExtendedTrackingRecorderCheckpointStatus>(partitionKey, rowKey);
...
//                if (tableResult != null)
//                {
//                    var x = (ExtendedTrackingRecorderCheckpointStatus)tableResult;
...
//                statusEntity = new ExtendedTrackingRecorderCheckpointStatus()
//                {
//                    PartitionKey = partitionKey,
//                    RowKey = rowKey,
//                    ConsumerGroupName = context.ConsumerGroup,
